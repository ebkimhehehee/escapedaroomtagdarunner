...
class Start_screen:
    ...
    def update(self):
        ...
        self.screen.blit(
            titlep1_image,
            (0.33 * self.screen.get_width(), 0.05 * self.screen.get_height()),
        )
        self.screen.blit(
            titlep2_image,
            (0.35 * self.screen.get_width(), 0.12 * self.screen.get_height()),
        )
        self.screen.blit(
        ...
        self.screen.blit(
            runner_image,
            (0.05 * self.screen.get_width(), 0.2 * self.screen.get_height()),
        )
        self.screen.blit(
            tagger_image,
            (0.05 * self.screen.get_width(), 0.3 * self.screen.get_height()),
        )
        self.screen.blit(
            points_image,
            (0.05 * self.screen.get_width(), 0.4 * self.screen.get_height()),
        )
        self.screen.blit(
            run_tag_image,
            (0.05 * self.screen.get_width(), 0.5 * self.screen.get_height()),
        )
        self.screen.blit(
        ...
        self.screen.blit(
            walls_image,
            (0.05 * self.screen.get_width(), 0.7 * self.screen.get_height()),
        )
